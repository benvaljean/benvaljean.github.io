...
2.  Setup relevant auto-forwards for your acc and allow-relay rules if
    required.
3.  Install the MAIL::POP3Client module for perl, as otherwise the
    scruipt will be unable to perform the necessary POP3 connections.
    The package name varies from distro to distro. On Ubuntu it is
