...
-   [Remove spaces or any character from a string (Bash)Remove spaces or
    any character from a
    string](Remove_spaces_or_any_character_from_a_string_(Bash)Remove_spaces_or_any_character_from_a_string "wikilink")
