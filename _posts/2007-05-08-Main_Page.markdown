...
*Whereas some pages here are relatively new, most have not been updated
in a long time.* \_\_NOEDITSECTION\_\_

### Linux

-   [Getting started with Linux](Getting_started_with_Linux "wikilink")
...
-   [X Windows & Desktop
    Tricks](X_Windows_&_Desktop_Tricks_(Linux) "wikilink")
-   [Awk Tricks](Awk_Tricks "wikilink")
-   [Syslog](Syslog "wikilink")
-   [Logrotate](Logrotate_(Linux) "wikilink")
-   [Max file descriptor
    limit](Max_file_descriptor_limit_(Linux) "wikilink")
-   [Scan for SSH servers using
    nmap](Scan_for_SSH_servers_using_nmap_(Linux) "wikilink")
-   [ARP Cache Timeout](ARP_Cache_Timeout "wikilink")
-   [Disable Caps lock in Ubuntu
    16.04](Disable_Caps_lock_in_Ubuntu_16.04 "wikilink")
-   [Setup Gitlab behind off-loaded/reverse proxy SSL (such as AWS
    ALB)](Setup_Gitlab_behind_off-loaded/reverse_proxy_SSL_(such_as_AWS_ALB) "wikilink")
...
-   [Error: Could not find/open font when opening font \"xyz\", using
    internal non-scalable font
    (gnuplot)](Error:_Could_not_find/open_font_when_opening_font_"xyz",_using_internal_non-scalable_font_(gnuplot) "wikilink")
...
-   [Use smarthost with mailx/mail in
    Postfix](Use_smarthost_with_mailx/mail_(Postfix) "wikilink")
...
-   [Getting started with Java Jars and
    Classes](Getting_started_with_Java_Jars_and_Classes "wikilink")
...
-   [Remove spaces or any character from a
    string](Remove_spaces_or_any_character_from_a_string_(Bash) "wikilink")
...
-   [Simple Apache log file analyser using
    Awk](Simple_Apache_log_file_analyser_using_Awk "wikilink")
...
-   [Getting started with GIT](Getting_started_with_GIT "wikilink")
-   [Search/replace all git commit names and
    emails](Search/replace_all_git_commit_names_and_emails "wikilink")
...
-   [Bad owner name (check-names)
    Error](Bad_owner_name_(check-names)_Error_(BIND) "wikilink")
-   [DNS Failover / High
    Availability](DNS_Failover_/_High_Availability "wikilink")
...
-   [Access denied for root when granting privileges in
    MySQL](Access_denied_for_root_when_granting_privileges "wikilink")
...
-   [Show trigger SQL](Show_trigger_SQL_(PostgreSQL) "wikilink")
